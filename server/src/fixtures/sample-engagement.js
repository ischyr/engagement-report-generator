...
import { signatureBlockHtml } from '../services/signatures.service.js';
...
export const sampleAudit = {
  ...
  enumeration: [
    ...
    },
    {
      ...
      outputAt: new Date('2026-07-21T09:02:00.000Z'),
      phase: 'recon',
      order: 1,
    ...
    },
    {
      ...
      outputAt: new Date('2026-07-21T09:06:00.000Z'),
      phase: 'recon',
      order: 2,
    ...
    },
    {
      ...
      outputAt: new Date('2026-07-21T09:14:00.000Z'),
      phase: 'recon',
      order: 4,
      output: [
    ...
    },
    {
      ...
      outputAt: new Date('2026-07-21T11:02:00.000Z'),
...
export const sampleSignatures = {
  ...
  /*
   * Built by the real builder rather than written out again here.
   *
   * The hand-written copy that used to live here drifted the day signatures stopped being numbered
   * as figures: the app changed, the fixture did not, and the test render went on proving the old
   * behaviour. The detection block below is built from raw rows for the same reason.
   */
  get html() {
    return signatureBlockHtml(this.signatures);
  },
};
...
export const sampleScopeChanges = {
  ...
  sentence: 'One addition and one removal were agreed with the client while testing was under way.',
  /*
   * The narrative, written out here exactly as `scopeChangesFor()` builds it — the same two
   * changes as prose, so a Test render proves `{{@rich.scopeTimeline}}` resolves to something
   * a client could actually read.
   */
  html:
    '<p>One addition and one removal were agreed with the client while testing was under way.</p>' +
    '<p><strong>Day 3 — 22 July 2026</strong> — Added to scope: The staging API host was brought ' +
    'into scope for the remainder of the window (api-staging.acme.example). Agreed with Elena ' +
    'Marin by Email.</p>' +
    '<p><strong>Day 5 — 24 July 2026</strong> — Taken out of scope: Payment flows were excluded — ' +
    'the sandbox was unavailable for the whole window (pay.acme.example). Agreed with Elena Marin ' +
    'by Call.</p>',
  scopeChanges: [
    {
      kind: 'added',
...
const SAMPLE_DETECTION_ROWS = [
  {
    ...
    occurredAt: new Date('2026-07-21T09:12:00.000Z'),
  ...
  },
  {
    ...
    occurredAt: new Date('2026-07-22T11:40:00.000Z'),
    outcome: 'logged',
    noise: 'standard',
    detectedAt: new Date('2026-07-22T11:44:00.000Z'),
    respondedAt: null,
  ...
  },
  {
    ...
    occurredAt: new Date('2026-07-23T14:05:00.000Z'),
    outcome: 'blocked',
    noise: 'loud',
    detectedAt: new Date('2026-07-23T14:05:00.000Z'),
    respondedAt: new Date('2026-07-23T14:31:00.000Z'),
  ...
  },
  {
    ...
    occurredAt: new Date('2026-07-24T16:20:00.000Z'),
    outcome: 'unknown',
    noise: 'quiet',
    detectedAt: null,
    respondedAt: null,
...
const SAMPLE_PHISHING_ROWS = [
  {
    ...
    clickedAt: new Date('2026-07-22T09:06:00.000Z'),
    phishedAt: new Date('2026-07-22T09:08:00.000Z'),
  },
  {
    ...
    reported: false,
    sentAt: new Date('2026-07-22T09:00:00.000Z'),
    clickedAt: new Date('2026-07-22T09:41:00.000Z'),
  },
  {
    ...
    reported: true,
    sentAt: new Date('2026-07-22T09:00:00.000Z'),
    reportedAt: new Date('2026-07-22T09:04:00.000Z'),
  },
  {
...
/*
 * Through the service's own shaping, exactly as the detection sample is.
 *
 * It used to be built here by hand, and drifted: the real campaign gained milestones for the
 * operation timeline and the sample did not, so a template proved against the fixture printed a
 * timeline with no campaign in it. A fixture that builds its own version of a shape is a fixture
 * that will eventually describe an app that no longer exists.
 */
export const samplePhishing = campaignReport(SAMPLE_PHISHING_ROWS, (value) =>
  ...
  deliveries: [
    {
      version: '1.0',
      date: '09 March 2026',
      sentAt: '2026-08-01T16:20:00.000Z',
      channel: 'email',
