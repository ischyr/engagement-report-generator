...
export const ACTIONS = {
  ...
  AUDIT_TEXT_REPLACED: 'audit.text-replaced',
  ...
  /*
   * What the test changed on somebody else's system, and putting it back.
   *
   * Two actions rather than one, because they answer different questions: the log of a job wants
   * to show that something was disabled on Tuesday and re-enabled on Thursday, and a single
   * "intrusion.updated" would flatten both into a row nobody can read.
   */
  INTRUSION_RECORDED: 'intrusion.recorded',
  INTRUSION_REVERTED: 'intrusion.reverted',
  ...
  PHISHING_FINDING_DRAFTED: 'phishing.finding-drafted',
