...
const userSchema = new mongoose.Schema(
  {
     ...
     */
    /**
     * Whether this person's notifications also arrive as mail.
     *
     * On by default, because a notification nobody sees is the problem the mail exists to solve —
     * and off costs one click on the profile page. It does nothing at all until an administrator
     * has configured a mail server, so a fresh instance behaves exactly as it did before.
     */
