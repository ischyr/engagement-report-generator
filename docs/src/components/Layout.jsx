    ...
    <div className="min-h-screen">
      <header className="sticky top-0 z-30 border-b border-line-soft bg-canvas/85 backdrop-blur">
        <div className="mx-auto flex h-14 max-w-[90rem] items-center gap-3 px-4">
          ...
          {/*
            Out of the documentation and back to the front page.

            An anchor rather than a router link, because it is leaving this application: served
            under /docs it lands on the site, and hosted alone at a domain root it lands where it
            always did, which is here.
          */}
          <a href="/" className="flex items-center gap-2.5">
            ...
            <span className="leading-none">
              <span className="block text-sm font-semibold text-fg">Engy • Report Generation</span>
          ...
          <a
            href="https://github.com/ischyr/engy-report"
            target="_blank"
            rel="noreferrer"
