 ...
 */
/*
 * The screenshots the pages use are in `public/shots`, which Vite copies into the build without
 * being asked. They were briefly read out of the presentation workspace next door by a plugin, to
 * avoid two copies of two megabytes; that workspace is its own repository now, and a build that
 * reaches into a sibling checkout is worse than a second copy of some pictures.
 *
 * Re-take them with `npm run shots` from the repository root.
 */
