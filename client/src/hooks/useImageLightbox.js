  ...
  const collect = useCallback(() => {
    ...
    return [...root.querySelectorAll('img')]
      ...
      .map((img) => ({
        ...
        /*
         * The recording this still came out of, when it is one. A document can only hold the
         * frame, so in the app the frame is a way in to the thing it was taken from — otherwise
         * a recording could be uploaded, printed and never watched.
         */
