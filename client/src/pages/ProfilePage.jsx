      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card as="form" onSubmit={saveProfile}>
          ...
          <CardBody className="grid gap-4 sm:grid-cols-2">
            ...
            />
            {/*
              Here rather than on a card of its own: it is a fact about how to reach you, which is
              what the rest of this card is. It has no effect until an administrator has configured
              a mail server, and the hint says so rather than leaving somebody waiting for mail.
            */}
            <div className="sm:col-span-2">
              <Toggle
                checked={profile.emailNotifications}
                onChange={(emailNotifications) => setProfile({ ...profile, emailNotifications })}
                label="Email me my notifications"
                hint="Mentions, review requests and reminders arrive by email as well as in the inbox — if this instance has a mail server configured. Everything still appears in the inbox either way."
              />
            </div>
          </CardBody>
