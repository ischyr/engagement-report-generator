...
export default function DetectionTab({ audit, editable }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      {/*
        Above the log, because it is the question this tab is really asked: not "what did we record
        as detection" but "what did we do, and did anybody notice". It draws on three other tabs as
        well as this one, and renders nothing at all when there is nothing dated to show.
      */}
      <OperationTimeline audit={audit} />
