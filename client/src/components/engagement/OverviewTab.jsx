...
import RenameCard from './RenameCard.jsx';
...
export default function OverviewTab({ audit, editable, onPatch, onReload }) {
  ...
  useUnsavedWork(
    Boolean(form) && pristine !== null && JSON.stringify(form) !== pristine,
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1.5fr_1fr]">
      ...
      <div className="flex flex-col gap-6">
        ...
        {/*
          A tool rather than a property of the engagement, so it sits below the things that
          describe it. It reloads on its own because it writes to findings and sections this page
          does not otherwise own.
        */}
        <RenameCard audit={audit} editable={editable} onReload={onReload} />
