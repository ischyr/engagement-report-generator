...
const NAV = [
   ...
   * which one at this moment, and which has had nobody in it for days.
   */
  { to: '/now', label: 'Right now', icon: Radio },
  ...
  /* Last, and deliberately apart from everything above: nothing here belongs to the firm. */
  { to: '/scratchpad', label: 'Scratchpad', icon: NotebookPen },
];
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="min-w-0 flex-1 px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
          <div className="mx-auto w-full max-w-[88rem]">
            {/*
              Where a page's chunk is waited for.
              Here rather than around the whole shell, which is the difference between "the content
              area is loading" and the sidebar, the header and the follow bar all disappearing for a
