    ...
    >
      ...
      <header className="flex shrink-0 items-center gap-2 border-b border-line-soft px-3 py-2">
        ...
        <span className="flex shrink-0 items-center gap-1">
          ...
          <a
            /* The recording itself where there is one: "Open" should give you the evidence. */
            href={current.video || current.src}
            target="_blank"
            rel="noreferrer"
      ...
      >
        {/*
          A recording plays here instead of its still frame.

          Not zoomable or draggable, deliberately: the controls want the pointer, and a scrubber
          you cannot hit because the surface pans under you is worse than no zoom. The still is
          still what the report prints — this is the copy nobody has to take our word for.
        */}
        {current.video ? (
          <video
            key={current.video}
