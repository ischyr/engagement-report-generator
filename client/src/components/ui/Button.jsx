  ...
  return (
    <Tag
      ...
      className={cn(
        ...
        /*
         * A label never breaks, and a button is never squeezed.
         *
         * Both are needed and neither is enough on its own. In a flex row beside a line of
         * explanatory text the button was a shrinkable item, so it gave up width until "Post a test
         * message" wrapped onto two lines inside a box half the width of its own words. Stopping the
         * text wrapping alone would only have moved the damage — the box would still shrink and clip
         * instead. Together they mean the button is its natural size and the pressure falls on
         * whichever sibling is flexible, which is what a paragraph is for.
         */
